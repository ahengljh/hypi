...
rm result-interrupt.txt

echo 0 > /sys/block/nvme1n1/queue/io_poll
#echo -2 > /sys/block/nvme1n1/queue/io_poll_delay

echo "interrupt-based i/o sevices" >> result-interrupt.txt
...
#fio --name=OptaneInitialPerfTest --ioengine=pvsync2 --hipri --direct=1 --buffered=0 --size=100% --randrepeat=0 --time_based --ramp_time=0 --norandommap --refill_buffers --group_reporting  --percentile_list=1.0:25.0:50.0:75.0:90.0:99.0:99.9:99.99:99.999:99.9999:99.99999:99.999999:100.0  --filename=/dev/nvme1n1 --bs=512 --iodepth=1 --numjobs=6 --rw=$RW --runtime=60 >> result-interrupt.txt
